...
namespace TestCases.PortalTests
{
    ...
    public class SecretRelationshipTest : PortalTestInit
    {
        ...
        public void Can_secretRelationship_KeepSharing()
     {
            ...
            Assert.IsTrue(Mobile_WeChat_Utility.IsAtPerXpath(CSH5.UIElement.FaceRankingMobileElement.Comment), "图片显示描述语是否正确");
            ...
            Assert.IsTrue(Mobile_WeChat_Utility.IsAtPerXpath(CSH5.UIElement.FaceRankingMobileElement.Comment), "分享后回到关系识别页面");
            ...
            //分享之后能否正常使用
            FaceRankingMobilePage_WeChat.FaceRankingFromFile(美女美女);
            Thread.Sleep(5 * 1000);
            FaceRankingMobilePage_WeChat.CheckLinkAvailable();
            FaceRankingMobilePage_WeChat.FaceRankingFromFile(美女美女);
            Thread.Sleep(5 * 1000);
            ...
            Assert.IsTrue(Mobile_WeChat_Utility.IsAtPerXpath(CSH5.UIElement.FaceRankingMobileElement.Comment), "再次分享后能否正常使用");
        }
        ...
        public void Can_secretRelationship_Single()
        {
            ...
            FaceRankingMobilePage_WeChat.FaceRankingFromFile("mmexport1460546134950.jpg");
            Thread.Sleep(5*1000);
        ...
        public void Can_secretRelationship_Celebrity()
        {
            ...
            FaceRankingMobilePage_WeChat.ClickFaceRanking();
            FaceRankingMobilePage_WeChat.FaceRankingFromFile("mmexport1484563134540.jpg");            
            Thread.Sleep(10 * 1000);
            MobileAndroidDriver.GetScreenshot(filePath, "图片显示是否正确");
            Assert.IsTrue(Mobile_WeChat_Utility.IsAtPerXpath(CSH5.UIElement.FaceRankingMobileElement.Comment,"杨洋"), "图片显示描述语是否正确");
            Assert.IsTrue(FaceRankingMobilePage_WeChat.CheckOficailAccountShow(), "公众号名称是否正确显示");
            Assert.IsFalse(Mobile_WeChat_Utility.IsAtPerXpath(secretRelationshipElement.H5Reward_Resource_id), "奖励是否显示"); 
            ...
            Assert.IsTrue(Mobile_WeChat_Utility.IsAtPerXpath(CSH5.UIElement.FaceRankingMobileElement.Comment, "杨洋"), "图片显示描述语是否正确");
            Assert.IsTrue(FaceRankingMobilePage_WeChat.CheckOficailAccountShow(), "公众号名称是否正确显示");
            Assert.IsFalse(Mobile_WeChat_Utility.IsAtPerXpath(secretRelationshipElement.H5Reward_Resource_id, "reward_25_3"), "奖励是否显示");
        }
        ...
        public void Can_secretRelationship_Political()
        {
            ...
            FaceRankingMobilePage_WeChat.ClickFaceRanking();
            FaceRankingMobilePage_WeChat.FaceRankingFromFile("mmexport1481256514269.jpg");
            Thread.Sleep(5 * 1000);        
        ...
        public void Can_secretRelationship_NoneHuman()
        {
            ...
            FaceRankingMobilePage_WeChat.ClickFaceRanking();
            FaceRankingMobilePage_WeChat.FaceRankingFromFile("mmexport1463116029472.jpg");        
            Thread.Sleep(5 * 1000);
        ...
        public void Can_secretRelationship_Humanvague()
        {
            ...
            FaceRankingMobilePage_WeChat.ClickFaceRanking();
            FaceRankingMobilePage_WeChat.FaceRankingFromFile("mmexport1484632301860.jpg");
            Thread.Sleep(5 * 1000);
