...
namespace TestCases
{
    ...
    public class MomentsSnapshotTest : PortalTestInit
    {
        ...
        public void CheckOnMobile_Moments()
        {
            ...
            MobileH5.SendPhotoFromFileWithMenu("图片 4, 2017-02-03 16:00");
            Thread.Sleep(5 * 1000);
        ...
        public void CheckOnMobile_Details()
        {
            ...
            MobileAndroidDriver.AndroidInitialize();
            MobileH5.GetToTestAccount();
            MobileH5.SendPhotoFromFileWithMenu("图片 2, 2017-02-04 11:00");
            Thread.Sleep(5 * 1000);
            Assert.IsTrue(MobileH5.GetLatestMessageWithMenu().Text.Contains("[平台测试账号2] 说:ok"));
        }
        ...
        public void CheckOnMobile_OtherPhoto()
        {
            ...
            MobileAndroidDriver.AndroidInitialize();
            MobileH5.GetToTestAccount();
            MobileH5.SendPhotoFromFileWithMenu("图片 1, 2017-02-04 11:13");
            Thread.Sleep(5 * 1000);
            Assert.IsFalse(MobileH5.GetLatestMessageWithMenu().Text.Contains("[平台测试账号2] 说:ok"));
        }
